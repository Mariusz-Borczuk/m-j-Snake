...
def popup():
    ...
    label = tk.Label(        popup_window, text="Controls:", font=("Comic Sans", 14)    )
    label.pack(pady=20)
    label = tk.Label(        popup_window, text="W, A, S, D or Arrow keys to move", font=("Comic Sans", 14)    )
    label.pack(pady=20)
    label = tk.Label(        popup_window, text="Backspace to restart", font=("Comic Sans", 14)    )
    label.pack(pady=20)
    label = tk.Label(        popup_window, text="Q to quit", font=("Comic Sans", 14)
    )
    label.pack(pady=20)
    label = tk.Label(
    ...
    #popup_window.bind("<Enter>", close_popup)
...
def show_controls():
    ...
    button = tk.Button(popup_window, text="Close", font=("Comic Sans", 14), command=window.destroy)
    button.pack(pady=10)

    # Bind the enter key to the close button
    popup_window.bind("<Q>", lambda event: window.destroy())
    popup_window.focus_set()
    popup_window.grab_set()
    popup_window.wait_window()
